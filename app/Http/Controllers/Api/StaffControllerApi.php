...
class StaffControllerApi extends Controller
{
    ...
    public function listofsendedparcel($id)
    {
        ...
        return response()->json(array('listofparcels' => $myTask, 'title' => $title, 'userBranch_id' => $userBranch_id));
    }
    public function listofwaitingparcel($id)
    {
        ...
        $lw = 1;
        return response()->json(array('listofparcels' => $myTask, 'title' => $title, 'userBranch_id' => $recipientBranch_id, 'lw' => $lw));
    }
