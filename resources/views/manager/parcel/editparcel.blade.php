...
@section('content')
{!!Form::open(['route'=>['manager.parcel.updateparcel', $parcel->id], 'enctype' => 'multipart/form-data',
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col">
                                    <br>{{ Form::text('parcelPriceUS', $parcel->parcelPriceUS, ['class' => 'form-control', 'data-toggle'=>'tooltip', 'title'=>'Цена перевозки в валюте','placeholder'=>'Валюта', 'id'=>'parcelPriceUS', 'onkeyup'=>'priceCustomUS();']) }}
                                </div>
                                <div class="col">
                                    <br>{{ Form::text('parcelPriceRU', $parcel->parcelPriceRU, ['class' => 'form-control', 'data-toggle'=>'tooltip', 'title'=>'Цена перевозки в рублях','placeholder'=>'Рубль', 'id'=>'parcelPriceRU', 'onkeyup'=>'priceCustomRU();']) }}
                                </div>
                                <div class="col">
                                    <br>{{ Form::text('parcelPriceUZS', $parcel->parcelPriceUZS, ['class' => 'form-control', 'data-toggle'=>'tooltip', 'title'=>'Цена перевозки в сумах','placeholder'=>'Сум', 'id'=>'parcelPriceUZS', 'onkeyup'=>'priceCustomUZS();']) }}
                                </div>
