...
@section('content')
{!!Form::open(['route'=>['manager.parcel.findparcel'], 'enctype' => 'multipart/form-data', 'method'=>'POST', 'files' =>
true])!!}
@csrf
{{csrf_field()}}
<div class="container">
                ...
                <div class="card-header">
                    <div style="display: flex; justify-content: space-between; padding:0px;">
                        ...
                        <div class="btn-group " role="group" aria-label="Basic example">
                            <div class="row">
                                <div class="col">
                                    {!!Form::open(['route'=>['manager.parcel.massupdateparcel'],'method'=>'POST'])!!}
                                    ...
                                    {!!Form::close()!!}</div>
                                <div class="col">
                                    {!!Form::open(['route'=>['manager.parcel.massupdateparcell'],'method'=>'POST'])!!}
                                    {!! Form::hidden('tags', json_encode($tags)) !!}
                                    @csrf
                                    {{csrf_field()}}
                                    <button
