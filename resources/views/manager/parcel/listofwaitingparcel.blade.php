                    ...
                    <div style="display: flex; justify-content: space-between; padding:0px;">
                        ...
                        <div class="btn-group " role="group" aria-label="Basic example">
                            <select multiple="multiple" id="tooggle-column"
                                ...
                                {{-- <option value="9" selected>Тип клиента</option> --}}
                                <option value="10" selected>Статус</option>
                                <option value="11" selected>Действие</option>
                    ...
                    <table id="my_table" class="table  table-sm table-striped table-hover" data-page-length='50'>
                        <thead style="background-color:#1c87c9; color:#fff; font-weight: bold; ">
                            <tr>
                                ...
                                {{-- <td class="text-center">Тип клиента</td> --}}
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    {{-- <a href="{{route('manager.parcel.pdfInvoice', $listofparcel->id)}}"><i
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <a href="{{route('manager.parcel.pdfInvoice', $listofparcel->id)}}"
                                                        class="btn btn-danger btn-block">Печать чека для клейки в
                                                        посылку</a></div>
                                            </div>
                                            <br>
                                            <div class="row">
