            ...
            <div class="card">
                <div class="card-header">
                    <div style="display: flex; justify-content: space-between; padding:0px;">
                        ...
                        <div class="btn-group " role="group" aria-label="Basic example">
                            ...
                            <a href="{{route('manager')}}" class="btn btn-primary btn-sm auto my-1"><i
                                    class="fa fa-arrow-left"></i></a>
                            <a href="{{route('manager.parcel.addparcel')}}" class="btn btn-primary btn-sm auto my-1"><i
                ...
                <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    {{date('d-M. Y г.', strtotime($listofparcel->parcelCurrentStatusUpdateDate))}}
                                </td>
                                <td class="text-center">
                                ...
                                <td class="text-center" style="width:10%">
                                    ...
                                    <a href="{{route('manager.parcel.updatestatus', $listofparcel->id)}}"
                                ...
                                <td class="text-center">
                                    <a href="{{route('manager.parcel.viewparcel', $listofparcel->id)}}"><i
                                            class="fa fa-eye"></i></a>
                                    <a data-toggle="modal" href="#exampleModalCenter{{ $listofparcel->id}}"
                                        data_value="{{ $listofparcel->id }}"><i class="fa fa-print"></i></a>

                                    <a href="{{route('manager.parcel.editparcel', $listofparcel->id)}}"><i
                                            class="fa fa-edit"></i></a>

                                    {!!Form::open(['route'=>['manager.parcel.delete', $listofparcel->id,
                            ...
                            <!-- Modal -->
                            <div class="modal fade" id="exampleModalCenter{{ $listofparcel->id}}" tabindex="-1"
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    ...
                                                    <a href="{{route('manager.parcel.pdfInvoice', $listofparcel->id)}}"
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <a href="{{route('manager.parcel.pdfInvoicea4', $listofparcel->id)}}"
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <a href="{{route('manager.parcel.shtrixCode', $listofparcel->id)}}"
                                                        class="btn btn-secondary btn-block">Печать чека</a>
                                                </div>
                                            </div>
                    ...
                    <ul class="pagination justify-content-end" style="margin:20px 0">
                        {{-- <li class="page-item">{{$listofparcels->links()}}</li> --}}
                    </ul>
                </div>
            </div>
        </div>
