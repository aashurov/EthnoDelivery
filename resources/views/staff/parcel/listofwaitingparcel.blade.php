                ...
                <div class="card-header">
                    <div style="display: flex; justify-content: space-between; padding:0px;">
                        ...
                        <div class="btn-group " role="group" aria-label="Basic example">
                            ...
                            <a href="{{route('staff')}}" class="btn btn-primary btn-sm auto my-1"><i
                                    class="fa fa-arrow-left"></i></a>
                            <a href="{{route('staff.parcel.addparcel')}}" class="btn btn-primary btn-sm auto my-1"><i
                    ...
                    <table id="my_table" class="table  table-sm table-striped table-hover" data-page-length='50'>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{route('staff.parcel.viewparcel', $listofparcel->id)}}"><i
                                            class="fa fa-eye"></i></a>
                                    <a data-toggle="modal" href="#exampleModalCenter"><i class="fa fa-print"></i></a>

                                    <a href="{{route('staff.parcel.editparcel', $listofparcel->id)}}"><i
                                            class="fa fa-edit"></i></a>
                                    {!!Form::open(['route'=>['staff.parcel.delete', $listofparcel->id,
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <a href="{{route('staff.parcel.pdfInvoice', $listofparcel->id)}}"
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <a href="{{route('staff.parcel.pdfInvoicea4', $listofparcel->id)}}"
