                ...
                <div class="card-header" style="font-weight:bold">
                    <div style="display: flex; justify-content: space-between; padding:0px;">
                        ...
                        <div class="btn-group " role="group" aria-label="Basic example">
                            ...
                            {{-- <a href="{{route('director.parcel.listofsendedparcel', 0)}}" class="btn btn-primary
                        ...
                        <table class='table table-bordered table-sm'>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">{{$parcel->senderdirectorName}}</td>
                                </tr>
                                @if($parcel->recipientdirector_id != 0)

                                <tr>
                                    <td colspan="3" style="font-weight:bold">ФИО менеджер получатель</td>
                                    <td colspan="3">{{$parcel->recipientdirectorName}}</td>
                                </tr>
                        ...
                        <table class='table table-bordered table-sm'>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td colspan="4">
                                        <a class="image-link" data-fancybox="gallery" target="_blank"
                                            href="{{asset($parcel->parcelImage)}}">
                                            <img src="{{asset($parcel->parcelImage)}}" width="20" height="20"></a>
                                        @if($parcel->parcelInvoiceImage=='storage/images/nophoto.jpg')

                                        @else <a class="image-link" target="_blank" data-fancybox="gallery"
