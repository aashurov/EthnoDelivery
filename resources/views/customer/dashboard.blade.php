                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col text-center"><i class="fa fa-arrow-up"></i><a
                                href="{{route('customer.parcel.listofsendedparcel', '0')}}" class="stretched-link"></a>
                            {{$all}}</div>
                        <div class="col text-center"><i class="fa fa-arrow-down"></i><a
                                href="{{route('customer.parcel.listofwaitingparcel', '0')}}" class="stretched-link"></a>
                            {{$alll}}</div>
                    </div>
        ...
        <div class="col-md-3">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col text-center"><i class="fa fa-arrow-up"></i><a
                                href="{{route('customer.parcel.listofsendedparcel', '1')}}" class="stretched-link"></a>
                            {{$a1}}</div>
                        {{-- <div class="col text-center"><i class="fa fa-arrow-down"></i><a
                                href="{{route('customer.parcel.listofwaitingparcel', '1')}}"
    ...
    <div class="col-md-3">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col text-center"><i class="fa fa-arrow-up"></i><a
                            href="{{route('customer.parcel.listofsendedparcel', '2')}}" class="stretched-link"></a>
                        {{$a2}}</div>
                    {{-- <div class="col text-center"><i class="fa fa-arrow-down"></i><a
                            href="{{route('customer.parcel.listofwaitingparcel', '2')}}" class="stretched-link"></a>
                    {{$a22}}
                </div> --}}
            </div>
