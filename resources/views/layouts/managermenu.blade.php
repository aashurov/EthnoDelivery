            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('manager')}}">Главная</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="{{route('manager.parcel.addparcel')}}">Новая посылка</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('manager.parcel.searchparcel')}}">Поиск посылки</a>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="{{route('manager.parcel.listofsendedparcel', '0')}}">Все
                                    посылки</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="{{route('manager.parcel.listofsendedparcel', '1')}}">В
                                    обработке</a>
                                <a class="dropdown-item"
                                    href="{{route('manager.parcel.listofsendedparcel', '2')}}">Принят в городе
                                    отправителя</a>
                                <a class="dropdown-item"
                                    href="{{route('manager.parcel.listofsendedparcel', '3')}}">Отправлен в транзитный
                                    город</a>
                                <a class="dropdown-item"
                                    href="{{route('manager.parcel.listofsendedparcel', '4')}}">Отправлен в город
                                    получателя</a>
                                <a class="dropdown-item"
                                    href="{{route('manager.parcel.listofsendedparcel', '5')}}">Принят в городе
                                    получателя</a>
                                <a class="dropdown-item" href="{{route('manager.parcel.listofsendedparcel', '6')}}">На
                                    складе готов к выдаче</a>
                                <a class="dropdown-item" href="{{route('manager.parcel.listofsendedparcel', '7')}}">На
                                    доставке у курьера</a>
                                <a class="dropdown-item"
                                    href="{{route('manager.parcel.listofsendedparcel', '8')}}">Возвращен на склад
                                    доставки</a>
                                <a class="dropdown-item"
                                    href="{{route('manager.parcel.listofsendedparcel', '9')}}">Доставлен</a>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="{{route('manager.parcel.listofwaitingparcel', '0')}}">Все
                                    посылки</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item"
                                    href="{{route('manager.parcel.listofwaitingparcel', '4')}}">Отправлен в город
                                    получателя</a>
                                <a class="dropdown-item"
                                    href="{{route('manager.parcel.listofwaitingparcel', '5')}}">Принят в городе
                                    получателя</a>
                                <a class="dropdown-item" href="{{route('manager.parcel.listofwaitingparcel', '6')}}">На
                                    складе готов к выдаче</a>
                                <a class="dropdown-item" href="{{route('manager.parcel.listofwaitingparcel', '7')}}">На
                                    доставке у курьера</a>
                                <a class="dropdown-item"
                                    href="{{route('manager.parcel.listofwaitingparcel', '8')}}">Возвращен на склад
                                    доставки</a>
                                <a class="dropdown-item"
                                    href="{{route('manager.parcel.listofwaitingparcel', '9')}}">Доставлен</a>

                            </div>

                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('manager.parcel.parcelt')}}">ParcelT</a>
                        </li>
                         <li class="nav-item">
                            <a class="nav-link" href="{{route('manager.parcel.parcelm')}}">ParcelM</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('manager.parcel.parcelt')}}">CustomerM</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('manager.parcel.parcelt')}}">CustomerT</a>
                        </li>
                        @endguest
                    </ul>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right" role="menu" style="width:330px">
                                ...
                                <li style="padding:10px; ">
                                    <a href="{{route('manager.parcel.viewparcelNotify', ['id'=>$unreadNotification->data['0']['id'], 'n_id'=> $unreadNotification->id] )}}"
                                        class="dropdown-item">
                                        <div class="row">
                                ...
                                <li>
                                    <div class="dropdown-divider"></div> <a
                                        href="{{route('manager.parcel.markasread')}}" style="text-align: center"
