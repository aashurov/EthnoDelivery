                    ...
                    <div style="display: flex; justify-content: space-between; padding:0px;">
                        ...
                        <div class="btn-group " role="group" aria-label="Basic example">
                            <select multiple="multiple" id="tooggle-column"
                                ...
                                <option value="7" selected>Статус</option>
                                <option value="8" selected>Действие</option>
                            </select>
                            <a href="{{route('courier')}}" class="btn btn-primary btn-sm auto my-1"><i
                                    class="fa fa-arrow-left"></i></a>
                            {{-- <a href="{{route('courier.parcel.addparcel')}}" class="btn btn-primary btn-sm auto
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="{{route('courier.parcel.setdelivery', $listofparcel->id)}}"><i
                                            class="fa fa-check"></i></a>

                                    {{-- <a href="{{route('courier.parcel.editparcel', $listofparcel->id)}}"><i
                                        class="fa fa-edit"></i></a> --}}
                                    {{-- {!!Form::open(['route'=>['courier.parcel.delete', $listofparcel->id, $listofparcel->refNumber],'method'=>'DELETE'])!!}
                                        <button onclick="return confirm('Вы действительно хотите удалить посылку {{$listofparcel->refNumber}}')"><i
