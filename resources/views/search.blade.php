...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <div class="site-wrap" id="home-section">
        ...
        <div class="ftco-blocks-cover-1">
            ...
            <div class="site-section bg-light" id="search-section">
                <div class="container">
                    <div class="row mb-5 justify-content-center">
                        <div class="col-md-7 text-center">
                            <div class="block-heading-1">
                                <h2>Статистика вашей посылки</h2>
                                <p>Для подробной информации о посылке закажите обратный звонок</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="block__35630">
                        ...
                        <div class="col-md-12 col-lg-12">
                            <div class="vtl">
                                ...
                                <div class="ewrap">
                                    <div class="event">
                                        Дата обновление статуса посылки:
                                        <b>
                                            <font color="black">{{ $item->parcelStatusDate }}</font>
                                        </b>
                                        <p class="text">
                                            Статус посылки: <b>
                                                <font color="black">{{$item->parcelStatus}}</font>
                                            </b>
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="ewrap">
                                    <div class="event">
                                        Ваша посылка не найдено. Возможно вы ввели неправильный номер посылки
                                    </div>
                                </div>
                                @endif
                            </div>
