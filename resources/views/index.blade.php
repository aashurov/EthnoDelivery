...
<script type="text/javascript" >
 ...
 <noscript><div><img src="https://mc.yandex.ru/watch/64702225" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
 /Yandex.Metrika counter -->
                    ...
                    <div class="col-12">
                        <nav class="site-navigation text-right ml-auto " role="navigation">
                            <ul class="site-menu main-menu js-clone-nav ml-auto d-none d-lg-block">
                                ...
                                <li><a href="#oferta-section" class="nav-link">Оферта</a></li>
...
<div class="site-section" id="oferta-section">
    <div class="container">
        <div class="row mb-5">
            <div class="block-heading-1 col-12 text-center">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="mb-12" data-aos="fade-up" data-aos-delay="100">
                    <h3 class="text-black h4 mb-4"><span
                            class="icon-question_answer text-primary mr-2"></span>1. Общие положения</h3>
                    <p>1.1. Общество с ограниченной ответственностью "ООО ЭТНО ДЕЛИВЕРИ РУС", в лице генерального директора Абдуллаев А.Т. далее, как «Продавец», публикует публичную оферту о предоставлении услуг по образцам, представленным на официальном интернет-сайте «Продавца» https://www.ethno.uz/.</p>
                        <p> 1.2. В соответствии со статьей 437 Гражданского Кодекса Российской Федерации (ГК РФ) данный документ является публичной офертой, и в случае принятия изложенных ниже условий физическое лицо, производящее “Акцепт” этой оферты, осуществляет оплату услуг «Продавца» в соответствии с условиями настоящего договора. В соответствии с пунктом 3 статьи 438 ГК РФ, оплата услуг клиентом является акцептом оферты, что считается равносильным заключению
                            договора на условиях, изложенных в оферте.</p>
                            <p>
                             1.3. На основании вышеизложенного, внимательно ознакомьтесь с текстом публичной оферты и, если вы не согласны с каким-либо пунктом оферты, Вам предлагается отказаться от покупки товаров или использования услуг, предоставляемых «Продавцом». Данная оферта является дополнение к оферте "ООО ЭТНО ДЕЛИВЕРИ РУС".
                            </p>
                            <p>
                            ...
                            <p>
                             1.6. «Клиент» – физическое лицо, заключившее с «Продавцом» договор на условиях, содержащихся в договоре.
                            </p>
                            <p>
                             1.7. «Акцепт» – полное и безоговорочное принятие «Покупателем» условий договора.
                            </p>
                            <p>
                             1.8. «Услуга» – перевозка и сопутствующая ей деятельность, а также любая иная деятельность в рамках Законодательства РФ.
                            </p>
                            <p>
                             1.9. «Виды услуг» — ассортимент предоставляемых услуг, таких как дополнительная упаковка, проверка заказа и прочее.
                            </p>
                            <p>
                             1.10. «Заказ» – отдельные позиции из ассортиментного перечня услуг, указанные «Покупателем» при оформлении заявки на интернет-сайте или через оператора.</p>
                </div>
                <div class="mb-12" data-aos="fade-up" data-aos-delay="100">
                    <h3 class="text-black h4 mb-4"><span
                    class="icon-question_answer text-primary mr-2"></span>2. Предмет договора</h3>
                    <p> 2.1. «Продавец» продает услугу в соответствии с действующим прейскурантом, опубликованным на интернет-сайте «Продавца» «https://www.ethno.uz/», а «Покупатель» производит оплату и принимает услугу в соответствии с условиями настоящего договора.</p>
                    <p> 2.1. «Продавец» продает услугу в соответствии с действующим прейскурантом, опубликованным на интернет-сайте «Продавца» «https://www.ethno.uz/», а «Покупатель» производит оплату и принимает услугу в соответствии с условиями настоящего договора.</p>

                </div>
                <div class="mb-5" data-aos="fade-up" data-aos-delay="100">
                    <h3 class="text-black h4 mb-4"><span
                            class="icon-question_answer text-primary mr-2"></span>3. Оформление Заказа </h3>
                    <p>
                    3.1. Заказ услуги осуществляется «Покупателем» через Интернет-сайт https://www.ethno.uz/
                </p><p>
                    3.2. При оформлении заказа на интернет-сайте «Продавца» клиент обязуется предоставить следующую регистрационную информацию о себе:
                </p><p>
                    3.2.1. фамилия, имя;
                </p><p>
                    ...
                    3.2.5. Паспортные данные получателя.
                </p><p>
                    3.3. При оформлении Заказа через оператора клиент обязуется предоставить информацию, указанную в п. 3.2. настоящего договора. Принятие клиентом условий настоящего договора осуществляется посредством внесения клиентом соответствующих данных в регистрационную форму на интернет-сайте или при оформлении заказа через оператора. Клиент имеет право редактировать регистрационную информацию о себе. Оператор не изменяет и не редактирует регистрационную информацию о клиенте без согласия последнего. «Продавец» обязуется не сообщать данные клиенте, указанные при регистрации на сайте https://www.ethno.uz/ при оформлении заказа, лицам, не имеющим отношения к исполнению заказа. утвердив заказ выбранной услуги, клиент предоставляет оператору необходимую информацию в соответствии с порядком, указанном в п. 3.2. настоящего договора.
                </p><p>
                    3.4. Продавец и оператор не несут ответственности за содержание и достоверность информации, предоставленной клиентом при оформлении заказа.
                </p><p>
                    3.5. Клиент несёт ответственность за достоверность предоставленной информации при оформлении заказа.
                </p><p>
                    3.6. Оплата клиентом самостоятельно оформленного на интернетсайте Заказа означает согласие клиента с условиями настоящего договора. День оплаты Заказа является датой заключения договора купли-продажи между продавцом и клиентом.
                </p><p>
                    3.7. Все информационные материалы, представленные на сайте https://www.ethno.uz/, носят справочный характер и не могут в полной мере передавать достоверную информацию об определенных свойствах и характеристиках услуг. В случае возникновения у клиента вопросов, касающихся свойств и характеристик услуг, перед оформлением заказа ему необходимо обратиться за консультацией к оператору.
                </p>
                </div>

                <div class="mb-5" data-aos="fade-up" data-aos-delay="100">
                    <h3 class="text-black h4 mb-4"><span class="icon-question_answer text-primary mr-2"></span>4. Сроки исполнения Заказа </h3>
                    <p>4.1. Срок исполнения заказа зависит от времени, необходимого на обработку заказа и действий компании, связанных с ее основным видом деятельности. Срок исполнения заказа в исключительных случаях может быть оговорен с «Покупателем» индивидуально в зависимости от вида и количества заказанных услуг. «Продавец» обязуется уведомить покупателя об изменении комплектности выполнения его заказа через оператора.</p>
                    <p>4.2. В случае предоставления клиента недостоверной информации его контактных данных «Продавец» за ненадлежащее исполнение заказа ответственности не несет.</p>
                </div>

                <div class="mb-5" data-aos="fade-up" data-aos-delay="100">
                    <h3 class="text-black h4 mb-4"><span class="icon-question_answer text-primary mr-2"></span> 5. Оплата Заказа</h3>
                    <p>5.1. Оплата заказа осуществляется путем передачи клиента денежных средств посредством электронного денежного перевода. Подтверждением оплаты исполненного Заказа является списание денежных средств с электронного счета клиента, или фискальный чек при оплате заказа наличными деньгами. Так же, покупатель может проконтролировать факт оплаты в «Личном кабинете» клиента на интернет-сайте «https://www.ethno.uz/».</p>
                    <p> 5.2. Цены на любые позиции услуг, указанные на интернет-сайте «https://www.ethno.uz/», могут быть изменены «Продавцом» в одностороннем порядке без уведомления клиента.</p>
                    <p>5.3. В случае изменения цены на заказанные позиции услуг оператор обязуется в кратчайшие сроки проинформировать клиента о таком изменении. Клиент вправе подтвердить либо аннулировать заказ. В случае отсутствия связи с клиенте Заказ считается аннулированным в течение 14 календарных дней с момента оформления.</p>
                    <p>5.5. В случае изменения цены на заказанные позиции услуг оператор обязуется в кратчайшие сроки проинформировать клиента о таком изменении. Клиент вправе подтвердить либо аннулировать заказ. В случае отсутствия связи с клиенте Заказ считается аннулированным в течение 14 календарных дней с момента оформления.</p>
                    <p>5.6. Денежные средства принимаются следующим способом: безналичным платежом.</p>
                </div>

                <div class="mb-5" data-aos="fade-up" data-aos-delay="100">
                    <h3 class="text-black h4 mb-4"><span class="icon-question_answer text-primary mr-2"></span> 6. Авторские права</h3>
                    <p>6.1. Вся текстовая информация и графические изображения, размещенные на интернет-сайте https://www.ethno.uz/, являются собственностью «Продавца» и/или производителей услуг.</p>
                </div>
                <div class="mb-5" data-aos="fade-up" data-aos-delay="100">
                    <h3 class="text-black h4 mb-4"><span class="icon-question_answer text-primary mr-2"></span>7. Возврат Заказа</h3>
                    <p>7.1. В соответствии с п. 4. ст. 26.1. Закона РФ № 2300-I «О защите прав потребителей», клиент вправе отказаться от заказанной услуги в любое время до момента исполнения Заказа.</p>
                    <p>7.2. Покупатель вправе возвратить заказа в следующих случаях:</p>
                    <p>7.2.1. В случае указанными в пункте 7. Ответственность оферты "ООО ЭТНО ДЕЛИВЕРИ РУС".</p>
                    <p>7.2.2. при совершении ошибочного перевода через платежные системы.</p>
                    <p>7.3. Для возврата денежных средств, зачисленных на расчетный счет Продавца ошибочно, посредством платежных систем, клиент должен обратиться в службу поддержки с письменным заявлением с приложением копии паспорта и чеков/квитанций, подтверждающих ошибочное зачисление. Данное заявление необходимо направить по адресу: 117449, г. Москва, ул. Винокурова дом 7/5 корпус 3. В случае возникновения вопросов, свяжитесь с Службой поддержки любым удобным для вас способом: тел. +79266800899, e-mail: info@ethno.uz После получения письменного заявления с приложением копии паспорта и чеков/квитанций, представитель производит возврат в срок до 10 (десяти) рабочих дней со дня получения заявления на расчетный счет Клиента, указанный последним в своем заявлении. При этом «Продавец» вправе удерживать часть суммы перечисления в счет компенсации фактически понесенных расходов. Для возврата денежных средств на банковскую карту «Заказчику» необходимо заполнить “Заявление о возврате денежных средств”, которое высылается по требованию компанией на электронный адрес «Заказчика», и оправить его вместе с приложением копии паспорта по адресу: 117449, г. Москва, ул. Винокурова дом 7/5 корпус 3. Возврат денежных средств будет осуществлен на банковский счет Заказчика, указанный в заявлении, в течение 10 (Десяти) рабочих дней со дня получения «Заявление о возврате денежных средств» компанией. Срок рассмотрения Заявления и возврата денежных средств Клиенту начинает исчисляться с момента получения «Продавцом» заявления и рассчитывается в рабочих днях без учета праздников/выходных дней. Если заявление поступило «Продавцу» после 18.00 рабочего дня или в праздничный/выходной день, моментом получения «Продавцом» заявления считается следующий рабочий день (ближайший).</p>

                </div>
                <div class="mb-5" data-aos="fade-up" data-aos-delay="100">
                    <h3 class="text-black h4 mb-4"><span class="icon-question_answer text-primary mr-2"></span>8. Права, обязанности и ответственность</h3>
                    <p>8.1. «Продавец» вправе передавать свои права и обязанности по исполнению заказов третьим лицам.</p>
                    <p>8.2. «Продавец» имеет право на осуществление записи телефонных переговоров с клиентом. В соответствии с п. 4 ст. 16 Федерального закона “Об информации, информационных технологиях и о защите информации” «Продавец» обязуется: предотвращать попытки несанкционированного доступа к информации и/или передачу ее лицам, не имеющим непосредственного отношения к исполнению заказов; своевременно обнаруживать и пресекать такие факты. телефонные разговоры записываются в целях осуществления контроля деятельности оператора и контроля качества исполнения Заказов.</p>
                    <p>8.3. Все претензии по ненадлежащему исполнению заказа клиент вправе направить на адрес электронной почты, указанный на интернетсайте https://www.ethno.uz/, в разделе “Контакты” или отправить письмо администрации в разделе “Обратная связь”. Вся поступившая информация обрабатывается в кратчайшие сроки.</p>
                </div>
                <div class="col-md-6" style="text-align: center;">
                    <img src="{{ asset('imagesface/pod.jpeg')}}" class="img-thumbnail" style="width: 100%; margin-bottom: 10px;"><p></p><p><a href="{{ asset('imagesface/pod.pdf')}}" class="btn btn-default">Скачать ПУБЛИЧНАЯ-ОФЕРТА</a></p></div>
        </div>
    </div>
</div>
