...
function calculate() {
    ...
    var parcelLength = parseFloat(document.getElementById('parcelLengthText').value) * 0.01;
    var parcelWidth = parseFloat(document.getElementById('parcelWidthText').value) * 0.01;
    var parcelHeight = parseFloat(document.getElementById('parcelHeightText').value) * 0.01;
    ...
    if (parcelPlan_idComboBox == 1) {
        ...
        if (overallWeight > parcelWeight) {
            ...
            priceRU = priceUS * 62;
            priceUZS = priceUS * 9600;
            document.getElementById("timediv").style.display = "unset";
            document.getElementById('currentTime').innerHTML = "Стоимость перевозки вашей посылки до точки назначение составит <b>" + priceRU + " рублей" + " или " + priceUZS + " сумов";
            ...
            priceUZS = priceUS * 9600;
            document.getElementById("timediv").style.display = "unset";
            document.getElementById('currentTime').innerHTML = "Стоимость перевозки вашей посылки до точки назначение составит <b>" + priceRU + " рублей</b>" + " или <b>" + priceUZS + " сумов";
        }
